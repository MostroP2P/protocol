...
To create a new buy order the user should send a message to Mostro (wrapped in the [active transport](./overview.md#transports)) with the following message:
...
Mostro will send back a confirmation message, the decrypted content looks like the following:
